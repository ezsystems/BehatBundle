...
/**
 * Sentences for FieldTypes
 */
class FieldType implements Context
{
     ...
     */
    protected function createField($fieldType, $name = null, $required = false)
    {
     ...
     */
    protected function addValueConstraint($fieldType, $value, $constraint)
    {
        ...
        $this
            ->fieldConstructionObject['fieldType']
     ...
     */
    protected function createContent($field, $value)
    {
     ...
     */
    protected function setFieldContentState($stateFlag, $field = null, $value = null)
    {
    ...
    protected function getFieldContentState()
    {
     ...
     */
    protected function getThisContentTypeName($language = self::DEFAULT_LANGUAGE)
    {
     ...
     * @return string Name of the contenttype
     */
    protected function getThisContentName($language = self::DEFAULT_LANGUAGE)
    {
     ...
     */
    protected function getThisFieldTypeName($language = self::DEFAULT_LANGUAGE)
    {
     ...
     *
     * @return string identifier of the fieldtype
     */
    protected function getThisFieldTypeIdentifier()
    {
     ...
     *
     * @return int id of the current content being(or already) created
     */
